...
| --------------- | ----------- |
| [SinaSpeed](docs/SinaSpeed/blocks/sinaspeed.md) | Moves an axis with a given speed via telegram 1 |
| [SinaPos](docs/SinaPos/blocks/sinapos.md) | Controls an axis via the basic positioner technology from SINAMICS S/G |
| [SinaPara](docs/SinaPara/blocks/sinapara.md) | Read/write up to 16 parameters from/to a SINAMICS S/G drive |
| [SinaParaS](docs/SinaPara/blocks/sinaparas.md) | Read/write a single parameter from/to a SINAMICS S/G drive |
| [SinaInfeed](docs/SinaInfeed/blocks/sinainfeed.md) | Controls the infeed of a SINAMICS drive system via telegram 370 |
| [SinaInfeedTlg371](docs/SinaInfeed/blocks/sinainfeedtlg371.md) | Controls the infeed of a SINAMICS drive system via telegram 371 |
